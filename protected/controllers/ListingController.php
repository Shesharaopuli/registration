...
class ListingController extends Controller
{
	...
	{
		$model=new ListingModel('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ListingModel']))
			$model->attributes=$_GET['ListingModel'];
	 ...
	 * @param ListingModel $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='listing-model-form')
		{
