 ...
 */
class ListingModel extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('listing_price', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('listing_id, listing_name, listing_address, listing_price', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'listing' => array(self::BELONGS_TO, 'User', 'listing_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('listing_price',$this->listing_price,true);
	 ...
	 * @return ListingModel the static model class
	 */
